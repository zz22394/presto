...
import static com.facebook.presto.operator.scalar.JsonFunctions.JSON_UNKNOWN_FUNCTIONS;
...
public class FunctionRegistry
{
    ...
    public FunctionRegistry(TypeManager typeManager, BlockEncodingSerde blockEncodingSerde, FeaturesConfig featuresConfig)
    {
        ...
        FunctionListBuilder builder = new FunctionListBuilder(typeManager)
                ...
                .functions(JSON_UNKNOWN_FUNCTIONS)
                ...
                .functions(DECIMAL_TO_VARCHAR_CAST, DECIMAL_TO_INTEGER_CAST, DECIMAL_TO_BIGINT_CAST, DECIMAL_TO_DOUBLE_CAST, DECIMAL_TO_BOOLEAN_CAST, DECIMAL_TO_TINYINT_CAST, DECIMAL_TO_SMALLINT_CAST, DECIMAL_TO_FLOAT_CAST)
                .functions(VARCHAR_TO_DECIMAL_CAST, INTEGER_TO_DECIMAL_CAST, BIGINT_TO_DECIMAL_CAST, DOUBLE_TO_DECIMAL_CAST, BOOLEAN_TO_DECIMAL_CAST, TINYINT_TO_DECIMAL_CAST, SMALLINT_TO_DECIMAL_CAST, FLOAT_TO_DECIMAL_CAST)
