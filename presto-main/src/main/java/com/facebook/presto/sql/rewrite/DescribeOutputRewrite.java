        ...
        implements StatementRewrite.Rewrite
{
    ...
    {
        return (Statement) new Visitor(session, parser, metadata, queryExplainer, accessControl, experimentalSyntaxEnabled).process(node, null);
    }
            ...
            extends AstVisitor<Node, Void>
    {
        ...
        protected Node visitDescribeOutput(DescribeOutput node, Void context)
        {
            ...
            Statement statement = parser.createStatement(sqlString, parsingOptions);

            Analyzer analyzer = new Analyzer(session, metadata, parser, accessControl, queryExplainer, experimentalSyntaxEnabled);
