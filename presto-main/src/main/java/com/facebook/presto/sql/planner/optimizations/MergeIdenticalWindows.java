        ...
        implements PlanOptimizer
{
            ...
            extends SimplePlanRewriter<MergeIdenticalWindows.Context>
    {
                ...
                RewriteContext<MergeIdenticalWindows.Context> context)
        {
            ...
            return new WindowNode(
                    ...
                    collectedFunctions.windowFunctions.build(),
                    collectedFunctions.signatures.build(),
                    node.getHashSymbol(),
    ...
    private static class Context
    {
        ...
        private boolean collectFunctions(WindowNode window)
        {
            ...
            pair.windowFunctions.putAll(window.getWindowFunctions());
            pair.signatures.putAll(window.getSignatures());
        ...
        {
            final ImmutableMap.Builder<Symbol, FunctionCall> windowFunctions = new ImmutableMap.Builder<>();
            final ImmutableMap.Builder<Symbol, Signature> signatures = new ImmutableMap.Builder<>();
        }
    }
}
