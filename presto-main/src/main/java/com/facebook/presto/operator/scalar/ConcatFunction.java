        ...
        extends SqlScalarFunction
{
            ...
            extends SignatureBinder
    {
        ...
        private static TypeSignature varcharSignature(long length)
        {
            if (length > VarcharType.MAX_LENGTH) {
                return VarcharType.createUnboundedVarcharType().getTypeSignature();
            }
            return VarcharType.createVarcharType(Ints.saturatedCast(length)).getTypeSignature();
        }
        ...
        public Optional<Signature> bind(List<? extends Type> actualArgumentTypes)
        {
            ...
            for (Type type : actualArgumentTypes) {
                ...
                boundTypesSignatures.add(varcharSignature(paramLength));
            }
            ...
            return Optional.of(
                    new Signature(
                            ...
                            varcharSignature(lengthAccumulator),
