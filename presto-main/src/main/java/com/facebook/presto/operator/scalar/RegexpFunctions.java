...
public final class RegexpFunctions
{
    ...
    @LiteralParameters("x")
    public static RegexpGenericPattern castToRegexp(ConnectorSession session, @SqlType("varchar(x)") Slice pattern)
    {
    ...
    public static boolean regexpLike(@SqlType("varchar(x)") Slice source, @SqlType(RegexpType.NAME) RegexpGenericPattern regexpGenericPattern)
    {
    ...
    @LiteralParameters("x")
    @SqlType("varchar(x)")
    public static Slice regexpReplace(@SqlType("varchar(x)") Slice source, @SqlType(RegexpType.NAME) RegexpGenericPattern regexpGenericPattern)
    {
    ...
    @SqlType("varchar(z)")
    public static Slice regexpReplace(@SqlType("varchar(x)") Slice source, @SqlType(RegexpType.NAME) RegexpGenericPattern regexpGenericPattern, @SqlType("varchar(y)") Slice replacement)
    {
    ...
    public static Block regexpExtractAll(@SqlType("varchar(x)") Slice source, @SqlType(RegexpType.NAME) RegexpGenericPattern regexpGenericPattern)
    {
    ...
    @LiteralParameters("x")
    @SqlType("array(varchar(x))")
    public static Block regexpExtractAll(@SqlType("varchar(x)") Slice source, @SqlType(RegexpType.NAME) RegexpGenericPattern regexpGenericPattern, @SqlType(StandardTypes.BIGINT) long groupIndex)
    {
    ...
    @LiteralParameters("x")
    @SqlType("varchar(x)")
    public static Slice regexpExtract(@SqlType("varchar(x)") Slice source, @SqlType(RegexpType.NAME) RegexpGenericPattern regexpGenericPattern)
    {
    ...
    @LiteralParameters("x")
    @SqlType("varchar(x)")
    public static Slice regexpExtract(@SqlType("varchar(x)") Slice source, @SqlType(RegexpType.NAME) RegexpGenericPattern regexpGenericPattern, @SqlType(StandardTypes.BIGINT) long groupIndex)
    {
    ...
    @SqlType("array(varchar(x))")
    public static Block regexpSplit(@SqlType("varchar(x)") Slice source, @SqlType(RegexpType.NAME) RegexpGenericPattern regexpGenericPattern)
    {
