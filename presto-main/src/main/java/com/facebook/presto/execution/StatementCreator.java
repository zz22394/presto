...
public class StatementCreator
{
    ...
    public Statement createStatement(String query, Session session, ParsingOptions parsingOptions)
    {
        ...
        statement = sqlParser.createStatement(sqlString, parsingOptions);
        return statement;
    }
}
