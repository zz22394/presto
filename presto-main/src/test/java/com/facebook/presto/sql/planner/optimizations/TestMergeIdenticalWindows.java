...
public class TestMergeIdenticalWindows
{
    ...
    public void testMergeableWindowsAllOptimizers()
    {
        ...
        PlanMatchPattern pattern =
                anyTree(
                        window(ImmutableList.of(functionCall("sum", "quantity"), functionCall("sum", "discount")),
                                anyTree(
                                        window(ImmutableList.of(functionCall("sum", "quantity")),
    ...
    public void testIdenticalWindowSpecificationsABcpA()
    {
        ...
        assertUnitPlan(sql,
                anyTree(
                        window(ImmutableList.of(functionCall("sum", "discount")),
                                window(ImmutableList.of(functionCall("lag", "quantity", "*", "*")),
                                        project(
                                                window(ImmutableList.of(functionCall("sum", "quantity")),
                                                        any()))))));
    }
    ...
    public void testIdenticalWindowSpecificationsAAcpA()
    {
        ...
        assertUnitPlan(sql,
                anyTree(
                        window(ImmutableList.of(functionCall("sum", "discount"), functionCall("lag", "quantity", "*", "*")),
                                project(
                                        window(ImmutableList.of(functionCall("sum", "quantity")),
                                                any())))));
    }
