        ...
        extends AbstractTestFunctions
{
    ...
    public void testDoubleToDecimalCasts()
    {
        ...
        assertDecimalFunction("CAST(DOUBLE '1000' AS DECIMAL(4,0))", decimal("1000"));
        ...
        assertDecimalFunction("CAST(DOUBLE '1234567890' AS DECIMAL(20,10))", decimal("1234567890.0000000000"));
        assertDecimalFunction("CAST(DOUBLE '-1234567890' AS DECIMAL(20,10))", decimal("-1234567890.0000000000"));
