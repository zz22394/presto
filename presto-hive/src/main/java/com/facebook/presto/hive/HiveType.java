...
public final class HiveType
{
    ...
    {
        this.hiveTypeName = checkNotNull(typeInfo, "typeInfo is null").getTypeName();
    ...
    {
        checkNotNull(hiveTypeName, "hiveTypeName is null");
    ...
    {
        checkNotNull(hiveTypes, "hiveTypes is null");
    ...
    {
        checkNotNull(typeInfo, "typeInfo is null");
