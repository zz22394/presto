...
public final class HiveType
{
    ...
    public static Type getType(String hiveType, TypeManager typeManager)
    {
        ...
        if (typeManager != null) {
            // todo support full structs types
            ...
            if (typeInfo.getCategory() == Category.MAP) {
                MapTypeInfo listTypeInfo = (MapTypeInfo) typeInfo;
                TypeSignature keyType = getType(listTypeInfo.getMapKeyTypeInfo().getTypeName(), typeManager).getTypeSignature();
                TypeSignature valueType = getType(listTypeInfo.getMapValueTypeInfo().getTypeName(), typeManager).getTypeSignature();
