        ...
        extends AbstractTestIntegrationSmokeTest
{
            ...
            throws Exception
    {
        @Language("SQL") String createTable = "" +
                ...
                "partitioned_by = ARRAY[ '_partition_string', '_partition_varchar', '_partition_tinyint', '_partition_smallint', '_partition_char', '_partition_integer', '_partition_bigint', '_partition_decimal_short', '_partition_decimal_long' ]" +
                ") ";
        ...
        List<String> partitionedBy = ImmutableList.of("_partition_string", "_partition_varchar", "_partition_tinyint", "_partition_smallint", "_partition_char", "_partition_integer", "_partition_bigint", "_partition_decimal_short", "_partition_decimal_long");
            ...
            throws Exception
    {
        ...
        assertUpdate("CREATE TABLE tmp_map3b AS SELECT MAP(ARRAY[DOUBLE '1.0'], ARRAY[DOUBLE '2.5']) AS col", 1);
        assertQuery("SELECT col[1.0] FROM tmp_map3b", "SELECT 2.5");
