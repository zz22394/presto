        ...
        extends AbstractTestIntegrationSmokeTest
{
            ...
            throws Exception
    {
        ...
        assertQuery("SELECT * from test_insert_format_table where _bigint = 2", "SELECT null, null, 2, 14.3, null, null, null");

        assertUpdate("INSERT INTO test_insert_format_table (_double, _bigint) SELECT DOUBLE '2.72', 3", 1);

        assertQuery("SELECT * from test_insert_format_table where _bigint = 3", "SELECT null, null, 3, 2.72, null, null, null");
