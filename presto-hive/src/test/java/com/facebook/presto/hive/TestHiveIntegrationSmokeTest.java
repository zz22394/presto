        ...
        extends AbstractTestIntegrationSmokeTest
{
            ...
            throws Exception
    {
        @Language("SQL") String createTable = "" +
                ...
                "partitioned_by = ARRAY[ '_partition_string', '_partition_varchar', '_partition_char', '_partition_integer', '_partition_bigint', '_partition_decimal_short', '_partition_decimal_long' ]" +
                ") ";
        ...
        List<String> partitionedBy = ImmutableList.of("_partition_string", "_partition_varchar", "_partition_char", "_partition_integer", "_partition_bigint", "_partition_decimal_short", "_partition_decimal_long");
            ...
            throws Exception
    {
        ...
        assertUpdate("INSERT INTO test_insert_format_table (_integer, _bigint, _double) SELECT CAST(1 AS INTEGER), 2, DOUBLE '14.3'", 1);

        assertQuery("SELECT * from test_insert_format_table where _bigint = 2", "SELECT null, null, null, 2, 1, 14.3, null, null, null");

        assertUpdate("INSERT INTO test_insert_format_table (_double, _bigint) SELECT DOUBLE '2.72', 3", 1);

        assertQuery("SELECT * from test_insert_format_table where _bigint = 3", "SELECT null, null, null, 3, null, 2.72, null, null, null");
        ...
        assertQuery("SELECT * from test_insert_format_table where _decimal_long = DECIMAL '98765432101234567890.0123456789'", "SELECT null, null, null, null, null, null, null, 2.72, 98765432101234567890.0123456789");
            ...
            throws Exception
    {
        ...
        assertUpdate("CREATE TABLE tmp_map3 AS SELECT MAP(ARRAY[DOUBLE '1.0'], ARRAY[DOUBLE '2.5']) AS col", 1);
        ...
        assertUpdate("CREATE TABLE tmp_map9 AS SELECT MAP(ARRAY[DOUBLE '1.0'], ARRAY[ARRAY[1, 2]]) AS col", 1);
        assertQuery("SELECT col[1.0][2] FROM tmp_map9", "SELECT 2");
    }
