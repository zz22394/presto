...
public class ErrorMessages
{
    ...
    private enum Tips {
        ...
        public static Builder builder(ClientSession session)
        {
    ...
    private static String prestoClientExceptionErrorMesage(PrestoClientException clientException, ClientSession session)
    {
        ...
        if (clientException.getServerException().isPresent()) {
            PrestoException.SerializedPrestoException exception = clientException.getServerException().get();
    ...
    private static void serverNotFoundErrorMessage(StringBuilder builder, ClientSession session)
    {
        ...
        Tips.Builder tipsBuilder = Tips.builder(session);
