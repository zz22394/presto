        ...
        extends AbstractTestQueries
{
            ...
            throws Exception
    {
        assertUpdate("CREATE TABLE presto_test_parameterized_varchar AS SELECT " +
                ...
                "CAST('b' AS varchar(65535)) text_b," +
                "CAST('c' AS varchar(16777215)) text_c," +
                "CAST('d' AS varchar(" + VarcharType.MAX_LENGTH + ")) text_d," +
        ...
        assertTableColumnNames("presto_test_parameterized_varchar", "text_a", "text_b", "text_c", "text_d", "text_unbounded");
        ...
        assertEquals(materializedRows.getTypes().get(3), VARCHAR);
        assertEquals(materializedRows.getTypes().get(4), VARCHAR);
        ...
        assertEquals(row.getField(4), "unbounded");
    ...
    public void testMySqlCreatedParameterizedVarchar()
            throws Exception
    {
        execute("CREATE TABLE tpch.mysql_test_parameterized_varchar (text_a tinytext, text_b text, text_c mediumtext, text_d longtext, text_e varchar(32))");
        execute("INSERT INTO tpch.mysql_test_parameterized_varchar VALUES('a', 'b', 'c', 'd', 'e')");
