...
{
    @Parameters({
            "hive.teradata.metastoreHost",
            "hive.teradata.metastorePort",
            "hive.teradata.databaseName",
            "hive.teradata.s3.awsAccessKey",
            "hive.teradata.s3.awsSecretKey",
            "hive.teradata.s3.writableBucket",
    })
    @BeforeClass
    @Override
