...
public class TestTeradataFunctions
{
    ...
    {
        assertFunction("CHAR2HEXINT('123')", createUnboundedVarcharType(), "003100320033");
        assertFunction("CHAR2HEXINT('One Ring')", createUnboundedVarcharType(), "004F006E0065002000520069006E0067");
    }

    @Test
    public void testChar2HexIntUtf8()
    {
        assertFunction("CHAR2HEXINT('\u0105')", createUnboundedVarcharType(), "0105");
        assertFunction("CHAR2HEXINT('\u0ca0')", createUnboundedVarcharType(), "0CA0");
        assertFunction("CHAR2HEXINT('\uff71')", createUnboundedVarcharType(), "FF71");
        assertFunction("CHAR2HEXINT('\u0ca0\u76ca\u0ca0')", createUnboundedVarcharType(), "0CA076CA0CA0");
        assertFunction("CHAR2HEXINT('(\u30ce\u0ca0\u76ca\u0ca0)\u30ce\u5f61\u253b\u2501\u253b')", createUnboundedVarcharType(), "002830CE0CA076CA0CA0002930CE5F61253B2501253B");
    }
