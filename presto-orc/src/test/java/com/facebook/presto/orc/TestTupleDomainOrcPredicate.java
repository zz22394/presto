...
public class TestTupleDomainOrcPredicate
{
            ...
            throws Exception
    {
        ...
        assertEquals(getDomain(FLOAT, 10, doubleColumnStats(10L, (double) 42.24f, (double) 42.24f)), singleValue(FLOAT, rawFloat(42.24f)));

        assertEquals(getDomain(FLOAT, 10, doubleColumnStats(10L, 3.3, (double) 42.24f)), create(ValueSet.ofRanges(range(FLOAT, rawFloat(3.3f), true, rawFloat(42.24f), true)), false));
        assertEquals(getDomain(FLOAT, 10, doubleColumnStats(10L, null, (double) 42.24f)), create(ValueSet.ofRanges(lessThanOrEqual(FLOAT, rawFloat(42.24f))), false));
        assertEquals(getDomain(FLOAT, 10, doubleColumnStats(10L, 3.3, null)), create(ValueSet.ofRanges(greaterThanOrEqual(FLOAT, rawFloat(3.3f))), false));

        assertEquals(getDomain(FLOAT, 10, doubleColumnStats(5L, 3.3, (double) 42.24f)), create(ValueSet.ofRanges(range(FLOAT, rawFloat(3.3f), true, rawFloat(42.24f), true)), true));
        assertEquals(getDomain(FLOAT, 10, doubleColumnStats(5L, null, (double) 42.24f)), create(ValueSet.ofRanges(lessThanOrEqual(FLOAT, rawFloat(42.24f))), true));
        assertEquals(getDomain(FLOAT, 10, doubleColumnStats(5L, 3.3, null)), create(ValueSet.ofRanges(greaterThanOrEqual(FLOAT, rawFloat(3.3f))), true));
    }

    private long rawFloat(float value)
    {
