...
public class TestBlackHoleSmoke
{
            ...
            throws Exception
    {
        ...
        assertEquals(row.getField(5), 0.0);
        assertEquals(row.getField(6), false);
        assertEquals(row.getField(7), new Date(0));
        assertEquals(row.getField(8), new Timestamp(0));
        assertEquals(row.getField(9), "****************".getBytes());
        assertEquals(row.getField(10), new BigDecimal("0.00"));
        assertEquals(row.getField(11), new BigDecimal("00000000000000000000.0000000000"));
        dropBlackholeAllTypesTable();
    }
            ...
            throws Exception
    {
        ...
        Duration pageProcessingDelay = Duration.valueOf("2s");
