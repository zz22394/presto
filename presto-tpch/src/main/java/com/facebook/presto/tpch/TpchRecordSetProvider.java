        ...
        implements ConnectorRecordSetProvider
{
    ...
    public RecordSet getRecordSet(ConnectorTransactionHandle transaction, ConnectorSession session, ConnectorSplit split, List<? extends ColumnHandle> columns)
    {
        ...
        return getRecordSet(tpchTable, columns, tpchSplit.getTableHandle().getScaleFactor(), tpchSplit.getTableHandle().isUseDecimal(), tpchSplit.getPartNumber(), tpchSplit.getTotalParts());
    }
            ...
            int totalParts)
    {
        ...
        return createTpchRecordSet(table, builder.build(), scaleFactor, useDecimal, partNumber + 1, totalParts);
    }
