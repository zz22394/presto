        ...
        implements RecordSet
{
    ...
    public static <E extends TpchEntity> TpchRecordSet<E> createTpchRecordSet(
            ...
            int partCount)
    {
        return new TpchRecordSet<>(table.createGenerator(scaleFactor, part, partCount), columns, useDecimal);
    }
    ...
    public TpchRecordSet(Iterable<E> table, Iterable<TpchColumn<E>> columns, boolean useDecimal)
    {
        ...
        this.columnTypes = ImmutableList.copyOf(transform(columns, column -> getPrestoType(column.getType(), useDecimal)));
    ...
    {
        return new TpchRecordCursor<>(table.iterator(), columns, useDecimal);
    }
            ...
            implements RecordCursor
    {
        ...
        public TpchRecordCursor(Iterator<E> rows, List<TpchColumn<E>> columns, boolean useDecimal)
        {
            this.rows = rows;
        ...
        {
            return getPrestoType(getTpchColumn(field).getType(), useDecimal);
        }
