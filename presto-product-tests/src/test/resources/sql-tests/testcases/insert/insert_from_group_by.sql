...
--!
insert into ${mutableTables.datatype} select count(*), 1.1, 'a', cast('2016-01-01' as date), cast('2015-01-01 03:15:16 UTC' as timestamp), FALSE from datatype group by c_bigint;
