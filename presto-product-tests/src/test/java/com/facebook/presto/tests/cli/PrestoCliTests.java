        ...
        implements RequirementsProvider
{
    ...
    private static final String[] NATION_TABLE_LINES = new String[] {
    ...
    private static final String[] NATION_TABLE_BATCH_LINES = new String[] {
            "\"0\",\"ALGERIA\",\"0\",\" haggle. carefully final deposits detect slyly agai\"",
            "\"1\",\"ARGENTINA\",\"1\",\"al foxes promise slyly according to the regular accounts. bold requests alon\"",
            "\"2\",\"BRAZIL\",\"1\",\"y alongside of the pending deposits. carefully special packages are about the ironic forges. slyly special \"",
            "\"3\",\"CANADA\",\"1\",\"eas hang ironic, silent packages. slyly regular packages are furiously over the tithes. fluffily bold\"",
    ...
    {
        if (presto != null) {
            presto.in.println(EXIT_COMMAND);
            ...
            throws IOException, InterruptedException
    {
        ...
        presto.in.println("select * from hive.default.nation;");
        assertThat(trimLines(presto.readLinesUntilPrompt())).contains(NATION_TABLE_LINES);
    }
            ...
            throws IOException, InterruptedException
    {
        ...
        assertThat(trimLines(presto.readRemainingLines())).contains(NATION_TABLE_BATCH_LINES);
    }
