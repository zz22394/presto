-- database: presto; groups: insert; mutable_tables: datatype_no_decimal|loaded
-- delimiter: |; ignoreOrder: true; 
--!
insert into ${mutableTables.hive.datatype_no_decimal} select * from ${mutableTables.hive.datatype_no_decimal};
