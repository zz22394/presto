        ...
        extends AbstractTestQueries
{
            ...
            throws Exception
    {
        ...
        assertTableColumnNames("presto_test_parameterized_varchar", "text_a", "text_unbounded");
        ...
        assertEquals(materializedRows.getTypes().get(1), VARCHAR);

        MaterializedRow row = getOnlyElement(materializedRows);
        assertEquals(row.getField(0), "a");
        assertEquals(row.getField(1), "unbounded");
    ...
    public void testPostgreSqlCreatedParameterizedVarchar()
            throws Exception
    {
        execute("CREATE TABLE tpch.postgresql_test_parameterized_varchar (text_a varchar(32), text_b text)");
        execute("INSERT INTO tpch.postgresql_test_parameterized_varchar VALUES('a', 'b')");
