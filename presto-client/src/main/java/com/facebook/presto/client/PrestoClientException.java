        ...
        extends RuntimeException
{
    ...
    public PrestoClientException(String task, Request request, JsonResponse<QueryResults> response, SerializedPrestoException serverException)
    {
        this(task, request, response, Optional.of(serverException));
    }

    public PrestoClientException(String task, Request request, JsonResponse<QueryResults> response, Optional<SerializedPrestoException> serverException)
    {
