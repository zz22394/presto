...
public class PrestoServerException
       extends RuntimeException
{
    private final String task;
    private final Request request;
    private final JsonResponse<QueryResults> response;
    private final Optional<SerializedPrestoException> serverException;

    public PrestoServerException(String task, Request request, JsonResponse<QueryResults> response)
    {
        this(task, request, response, Optional.empty());
    }

    public PrestoServerException(String task, Request request, JsonResponse<QueryResults> response, SerializedPrestoException serverException)
    {
        this(task, request, response, Optional.of(serverException));
    }

    public PrestoServerException(String task, Request request, JsonResponse<QueryResults> response, Optional<SerializedPrestoException> serverException)
    {
    ...
    private static String getDefaultMessage(String task, Request request, JsonResponse<QueryResults> response, Optional<SerializedPrestoException> serverException)
    {
    ...
    public Optional<SerializedPrestoException> getServerException()
    {
