...
public class TestJdbcResultSet
{
    ...
    public void testObjectTypes()
            throws Exception
    {
        String sql = "SELECT 123, 12300000000, 0.1, true, 'hello', DOUBLE '1.0' / 0.0, DOUBLE '0.0' / 0.0, ARRAY[1, 2], cast('foo' as char(5)), FLOAT '123.45'";
        ...
        try (ResultSet rs = statement.executeQuery(sql)) {
            ...
            assertEquals(metadata.getColumnType(10), Types.REAL);
