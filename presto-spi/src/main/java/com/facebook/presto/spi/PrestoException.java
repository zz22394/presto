        ...
        extends RuntimeException
{
    ...
    public SerializedPrestoException getSerialized()
    {
        return new SerializedPrestoException(errorCode, getMessage(), getStackTraceString());
    }
    ...
    public static class SerializedPrestoException
    {
        private final ErrorCode errorCode;
        ...
        @JsonCreator
        public SerializedPrestoException(
